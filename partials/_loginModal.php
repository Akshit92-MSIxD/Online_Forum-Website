      ...
      <div class="modal-body">
       ...
       <form action="/online_forum/partials/_handle-loginModal.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="loginEmail" aria-describedby="emailHelp" name="loginEmail" required autocomplete="off">
                        ...
                        <label for="loginPassword" class="form-label">Password</label>
                            <input type="password" class="form-control" id="loginPassword" name = "loginPassword" required autocomplete="off">
                        </div>
